...
cdsl_ruleset_report_t*
cdsl_vm_execute_ruleset(struct cdsl_vm* vm, cdsl_ruleset_t* set, struct cdsl_context* ctx);
cdsl_ruleset_report_t* cdsl_vm_execute_ruleset_parallel(struct cdsl_vm* vm,
							cdsl_ruleset_t* set,
