...
cdsl_rule_report_t* cdsl_vm_execute(struct cdsl_vm* vm, const cdsl_rule_t* rule, struct cdsl_context* ctx);
...
cdsl_rule_report_t* cdsl_vm_execute_compiled(struct cdsl_vm* vm, struct cdsl_compiled_rule* compiled, struct cdsl_context* ctx);
