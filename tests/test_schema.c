...
test_type_compatibility()
{
	...
	cdsl_rule_t* rule1 = cdsl_parse_string(dsl1);
	...
	cdsl_rule_t* rule2 = cdsl_parse_string(dsl2);
...
test_string_comparison_validation()
{
	...
	cdsl_rule_t* rule3 = cdsl_parse_string(dsl3);
...
test_schema_edge_cases()
{
	...
	cdsl_rule_t* rule = cdsl_parse_string("RULE test { WHEN x > 0 THEN block(\"test\") }");
